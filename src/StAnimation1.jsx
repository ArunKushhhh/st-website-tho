...
import ScrollRevealMobile from "./components/mobile/ScrollRevealMobile";
...
function StAnimation1() {
  ...
  return (
    <div className="flex flex-col px-4  w-full">
      ...
      {isMobile ? (
        <ScrollRevealMobile {...sharedProps}>
          <div>
            <h2 className="text-lg md:text-xl font-bold">Job Opening</h2>
          </div>
        </ScrollRevealMobile>
      ) : (
