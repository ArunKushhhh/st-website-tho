      ...
      <div className="w-full px-0 py-4">
        ...
        <div
          ...
          style={{ 
            ...
            paddingBottom: isMobile && (scaledImageTop !== null || scaledImageBottom !== null) ? "120px" : "0px"
          }}
        >
          {/* Heading */}
          ...
          <div
            ref={mainSliderRef}
            className={`relative mb-4 w-full overflow-y-visible overflow-x-hidden transition-all duration-500 ease-out ${getSliderHeight(scaledImageTop)}`}
            style={{
          ...
          <div
            ref={bottomSliderRef}
            className={`relative w-full overflow-y-visible overflow-x-hidden  transition-all duration-500 ease-out ${getSliderHeight(scaledImageBottom)}`}
            style={{
              // Dynamic height and margin adjustments
              minHeight: isMobile && scaledImageBottom !== null ? "300px" : "auto",
